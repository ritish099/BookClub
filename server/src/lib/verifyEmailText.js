                ...
                <table role="presentation" style="max-width: 600px; border-collapse: collapse; border: 0px; border-spacing: 0px; text-align: left;">
                    ...
                    <tr>
                        ...
                        <div style="padding: 20px; background-color: rgb(255, 255, 255);">
                            ...
                            <h1 style="margin: 1rem 0">Book Club</h1>
                            <p style="padding-bottom: 16px">Thank you for signing up for bookclub.</p>
                            <p style="padding-bottom: 16px">Please click on the following link or paste it into your browser to complete the process:
                            </p>
                            <p style="padding-bottom: 16px"><a href="${url}" target="_blank"
                                style="padding: 12px 24px; border-radius: 4px; color: #FFF; background: #3F8EE9;display: inline-block;margin: 0.5rem 0;">Verify
                                Email</a></p>
                            <p style="padding-bottom: 16px">You could ignore this email if you did not ask to verify this address.</p>

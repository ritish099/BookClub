            ...
            <table role="presentation" style="max-width: 600px; border-collapse: collapse; border: 0px; border-spacing: 0px; text-align: left;">
                ...
                <tr>
                    ...
                    <div style="padding: 20px; background-color: rgb(255, 255, 255);">
                        ...
                        <p style="padding-bottom: 16px">Thank you for verifying your email address.</p>
                        <p style="padding-bottom: 16px">Now you can browse various books and you can buy them. Also, you can post your old ones to
                            sell them.</p>
                        <p style="padding-bottom: 16px">You can ignore this email if you didn’t ask to verify this address.</p>
